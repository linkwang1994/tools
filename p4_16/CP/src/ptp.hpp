...
#define PTP_GEN_REQ 0x11
#define PTP_CAPTURE_COMMAND 0x6
...
namespace ptp {
	...
	bf_status_t registerDigest(const char *ptp_followup_digest, const char *ptp_reply_digest, const char *ptp_reply_followup_digest);

	void createPtpRequestThread(uint32_t interval);
} // namespace ptp
